...
bool connect_dslink(int argc, const char* argv[], std::shared_ptr<App> app) {
  ...
  std::cout << cmdlog::error
            << "cannot connect to the broker! Be sure if you give broker "
...
//  std::cout<<cmdlog::info<<"Listing path :
//  "<<cmdlog::reset<<cmdlog::path<<"downstream"<<cmdlog::endl;
//  std::cout<<cmdlog::var<<"{\n 'mert' : 5 \n}"<<cmdlog::endl;
//  std::cout<<cmdlog::stream<<"Press enter to cancel the
//  stream..."<<cmdlog::endl; std::cout<<cmdlog::path<<">
//  downstream/mylink"<<cmdlog::endl;
//
//}
